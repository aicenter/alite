...
public class BoxZone implements Zone {
    ...
    boolean GetIntersection(double fDst1, double fDst2, Point3d P1, Point3d P2, Point3d hit) {
        if ((fDst1 * fDst2) >= 0.0)
            return false;
        if (fDst1 == fDst2)
            return false;
    ...
    boolean InBox(Point3d Hit, Point3d B1, Point3d B2, final int Axis) {
    ...
    boolean CheckLineBox(Point3d B1, Point3d B2, Point3d L1, Point3d L2, Point3d Hit) {
