...
@XmlType(name = "", propOrder = { "addressLine", "administrativeAreaName",
		"subAdministrativeArea", "locality", "postOffice", "postalCode", "any" })
@XmlRootElement(name = "AdministrativeArea")
public class AdministrativeArea implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7380791870528095932L;
	...
	public void setSubAdministrativeArea(
			AdministrativeArea.SubAdministrativeArea value) {
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link PostOffice }
	 * 
	 */
	...
	public static class AdministrativeAreaName implements java.io.Serializable {

		/**
		 * 
		 */
		private static final long serialVersionUID = -4261056378093487947L;
		@XmlValue
	...
	@XmlType(name = "", propOrder = { "addressLine",
			"subAdministrativeAreaName", "locality", "postOffice",
			"postalCode", "any" })
	public static class SubAdministrativeArea implements java.io.Serializable {

		/**
		 * 
		 */
		private static final long serialVersionUID = 1840157357734718427L;
		@XmlElement(name = "AddressLine")
		protected List<AddressLine> addressLine;
		...
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "content" })
		public static class SubAdministrativeAreaName implements
				java.io.Serializable {

			/**
			 * 
			 */
			private static final long serialVersionUID = 4506427619603643734L;
			@XmlValue
			protected String content;
			@XmlAttribute(name = "Type")
			@XmlSchemaType(name = "anySimpleType")
