...
@XmlType(name = "FirmType", propOrder = { "addressLine", "firmName",
		"department", "mailStop", "postalCode", "any" })
public class FirmType implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3018428784895968357L;
