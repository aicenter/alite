...
@XmlType(name = "AbstractOverlayType", propOrder = { "color", "drawOrder",
		"icon" })
@XmlSeeAlso( { PhotoOverlayType.class, ScreenOverlayType.class,
		GroundOverlayType.class })
public abstract class AbstractOverlayType extends AbstractFeatureType implements
		java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7656260455895036129L;
