...
/**
 * Interface for differs. Differ takes a part of structure, then generates differing structure and
 * updates actual state. Differ can be on server side and in realtime case on client side.
 * 
