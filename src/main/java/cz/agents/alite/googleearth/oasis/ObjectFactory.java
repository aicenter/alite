...
public class ObjectFactory implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6625239922853289356L;
	private final static QName _AddressDetails_QNAME = new QName(
			"urn:oasis:names:tc:ciq:xsdschema:xAL:2.0", "AddressDetails");
	...
	public JAXBElement<AddressDetails> createAddressDetails(AddressDetails value) {
		return new JAXBElement<AddressDetails>(_AddressDetails_QNAME,
				AddressDetails.class, null, value);
	}
