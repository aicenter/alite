...
@XmlSeeAlso( { ListStyleType.class, AbstractColorStyleType.class,
		BalloonStyleType.class })
public abstract class AbstractSubStyleType extends AbstractObjectType implements
		java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2834989952593375996L;
