...
/**
 * <p>Title: Air Traffic Control</p>
 *
 * <p>Description: The polyline in 3D representing the path found by the A* pathfinder. </p>
 *
...
//    public void drawInVisio(String layer, Color3f col) {
//        throw new RuntimeException();
//        try {
//            if (!VisioGL.isInitialized()) {
//                return;
//            }
//            Layer visioLayer = VisioGL.getLayer(layer);
//            if (visioLayer == null) {
//                visioLayer = VisioGL.addLayer(layer);
//            }
//            Group g = new Group();
//            visioLayer.addObject(new PointDecorator(g, 5));
//
//            LineSet lset = new LineSet();
//
...
//                    lastPoint = point;
//                }
//                lset.addLine(lastPoint, point);
//                lastPoint = point;
//            }
//            g.addObject(new ColorDecorator(
//                    new LineDecorator(lset, 2), col));
//
//            VisioGL.redraw();
